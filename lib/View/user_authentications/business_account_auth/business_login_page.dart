...
import 'package:nocturna/View/user_authentications/business_account_auth/business_forgot_password_page.dart';
import 'package:nocturna/View/widgets/personal_account_bottom_navigation_bar.dart';

class BusinessAccountLoginPage extends StatelessWidget {
  const BusinessAccountLoginPage({super.key});
                ...
                Padding(
                  ...
                  child: TextButton(
                    onPressed: () {
                      ...
                      Get.to(() => const BusinessAcountForgotPasswordPage());
                    },
                    child: Text(
                      'Forgot Password?',
                      style: Theme.of(context).textTheme.bodyMedium,
